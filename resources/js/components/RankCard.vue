<template>
  <div
    class="ranking-card w-full min-h-[60px] flex items-center justify-between gap-2.5 p-2.5 font-poppins border-b-2 border-[#E4E4F1] overflow-hidden transition-all duration-300 hover:shadow-md hover:scale-105">
    <span v-if="index <= 2"
